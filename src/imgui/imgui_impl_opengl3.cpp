...
// Call ImGui_ImplOpenGL3_Init() with "#version 300 es"
    ...
    defined(IMGUI_IMPL_USE_GL_ES3)
#define USE_GL_ES3
#else
#define IMGUI_IMPL_OPENGL_HAS_GL_POLYGON_MODE
#define IMGUI_IMPL_OPENGL_HAS_GL_CLIP_ORIGIN
#endif
#define IMGUI_IMPL_OPENGL_HAS_GL_SAMPLER_BINDING
...
#include <glad/glad.h>
#else
#error "Need to choose what GL API header to use"
#endif
#endif
#endif
...
#ifdef IMGUI_IMPL_OPENGL_HAS_GL_SAMPLER_BINDING
    GLint last_sampler; glGetIntegerv(GL_SAMPLER_BINDING, &last_sampler);
#endif
    GLint last_array_buffer; glGetIntegerv(GL_ARRAY_BUFFER_BINDING, &last_array_buffer);
    GLint last_vertex_array; glGetIntegerv(GL_VERTEX_ARRAY_BINDING, &last_vertex_array);
#ifdef IMGUI_IMPL_OPENGL_HAS_GL_POLYGON_MODE
...
#ifdef IMGUI_IMPL_OPENGL_HAS_GL_CLIP_ORIGIN
